...
public class SessionVariable implements Serializable, Writable {
    ...
    public static final String AGG_SHUFFLE_KEY_SKEW_FACTOR = "agg_shuffle_key_skew_factor";
    ...
    @VariableMgr.VarAttr(name = AGG_SHUFFLE_USE_PARENT_KEY, needForward = false)
    ...
    @VariableMgr.VarAttr(name = AGG_SHUFFLE_KEY_SKEW_FACTOR)
    public double aggShuffleKeySkewFactor = 2.0;
