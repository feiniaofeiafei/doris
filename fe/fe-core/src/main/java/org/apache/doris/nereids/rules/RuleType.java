...
public enum RuleType {
    ...
    BINDING_ICEBERG_DELETE_SINK_OUTPUT(RuleTypeClass.REWRITE),
    BINDING_ICEBERG_MERGE_SINK_OUTPUT(RuleTypeClass.REWRITE),
    ...
    BINDING_INSERT_MAX_COMPUTE_TABLE(RuleTypeClass.REWRITE),
    BINDING_INSERT_JDBC_TABLE(RuleTypeClass.REWRITE),
    BINDING_INSERT_CONNECTOR_TABLE(RuleTypeClass.REWRITE),
    BINDING_INSERT_TARGET_TABLE(RuleTypeClass.REWRITE),
    BINDING_INSERT_DICTIONARY_TABLE(RuleTypeClass.REWRITE),
    BINDING_INSERT_TVF_TABLE(RuleTypeClass.REWRITE),
    ...
    BINDING_SKEW_EXPR(RuleTypeClass.REWRITE),
    BINDING_SALT_EXPR(RuleTypeClass.REWRITE),
    ...
    REWRITE_SIMPLE_AGG_TO_CONSTANT(RuleTypeClass.REWRITE),
    ...
    DISTINCT_WINDOW_EXPRESSION(RuleTypeClass.REWRITE),
    ...
    ELIMINATE_DISTINCT_CONSTANT(RuleTypeClass.REWRITE),
    ...
    CONSTANT_PROPAGATION(RuleTypeClass.REWRITE),
    ...
    PULL_UP_PROJECT_EXPR_UNDER_TOPN(RuleTypeClass.REWRITE),
    ...
    ELIMINATE_AGG_CASE_WHEN(RuleTypeClass.REWRITE),
    ...
    DISTINCT_AGG_STRATEGY_SELECTOR(RuleTypeClass.REWRITE),
    ...
    COLLECT_SCAN_FILTER(RuleTypeClass.REWRITE),
    COLLECT_SCAN_PROJECT_FILTER(RuleTypeClass.REWRITE),
    ...
    // limit above join or aggregate or scan
    MATERIALIZED_VIEW_LIMIT_UNARY_JOIN(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_LIMIT_UNARY_AGGREGATE(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_LIMIT_JOIN(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_LIMIT_AGGREGATE(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_LIMIT_SCAN(RuleTypeClass.MATERIALIZE_VIEW),

    // topN above join or aggregate or scan
    MATERIALIZED_VIEW_TOP_N_UNARY_JOIN(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_TOP_N_JOIN(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_PROJECT_TOP_N_UNARY_JOIN(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_PROJECT_TOP_N_JOIN(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_TOP_N_UNARY_AGGREGATE(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_TOP_N_AGGREGATE(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_PROJECT_TOP_N_UNARY_AGGREGATE(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_PROJECT_TOP_N_AGGREGATE(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_TOP_N_SCAN(RuleTypeClass.MATERIALIZE_VIEW),
    MATERIALIZED_VIEW_PROJECT_TOP_N_SCAN(RuleTypeClass.MATERIALIZE_VIEW),
    ...
    LOGICAL_WORK_TABLE_REFERENCE_TO_PHYSICAL_WORK_TABLE_REFERENCE(RuleTypeClass.IMPLEMENTATION),
    ...
    LOGICAL_CONNECTOR_TABLE_SINK_TO_PHYSICAL_CONNECTOR_TABLE_SINK_RULE(RuleTypeClass.IMPLEMENTATION),
    ...
    LOGICAL_DICTIONARY_SINK_TO_PHYSICAL_DICTIONARY_SINK_RULE(RuleTypeClass.IMPLEMENTATION),
    LOGICAL_TVF_TABLE_SINK_TO_PHYSICAL_TVF_TABLE_SINK_RULE(RuleTypeClass.IMPLEMENTATION),
    ...
    LOGICAL_RECURSIVE_UNION_TO_PHYSICAL_RECURSIVE_UNION(RuleTypeClass.IMPLEMENTATION),
    LOGICAL_RECURSIVE_UNION_PRODUCER_TO_PHYSICAL_RECURSIVE_UNION_PRODUCER(RuleTypeClass.IMPLEMENTATION),
    LOGICAL_RECURSIVE_UNION_ANCHOR_TO_PHYSICAL_RECURSIVE_UNION_ANCHOR(RuleTypeClass.IMPLEMENTATION),
    ...
    AGG_SKEW_REWRITE(RuleTypeClass.IMPLEMENTATION),
    LOGICAL_AGGREGATE_TO_PHYSICAL_HASH_AGGREGATE(RuleTypeClass.IMPLEMENTATION),
    SPLIT_AGG_WITHOUT_DISTINCT(RuleTypeClass.IMPLEMENTATION),
